...
import { OMNIDEF } from './carePlanUIEnglish_def.js';
import tmpl from './carePlanUIEnglish.html';
import tmpl_nds from './carePlanUIEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class carePlanUIEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
